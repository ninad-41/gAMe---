...
function draw() {
    ...
    fill(0);
    text("ALWAYS USE BRODERNESS BUTTON TO COLOUR. IT IS SET AS DEFAULT TO 0. SO ALWAYS INCREASE IT TO INCREASE YOUR COLOUR BRODERNESS!", displayWidth/4, displayHeight-140);
    text("WELCOME !!!", displayWidth/7+20, displayHeight/10-60);
